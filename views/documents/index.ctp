				...
				<div class="row-fluid">
					<div class="span4 module">
						<div class="module-wrap">
							<div class="module-name documents">
...
<div class="sub-content-container">
	<div class="w90 center">
		<div class="row-fluid">
			<div class="w90 center">
						<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable" id="DocumentTable" model="Document">
			<thead>
				<tr>
																								<th class="w10 text-center"><a >Name</a></th>
																				<th class="w10 text-center"><a >Dir</a></th>
																																<th class="actions w5"><a >Actions</a></th>
				</tr>
			</thead>
			<tbody>
					<td><span data-field='Document.name'></span></td>
		<td><span data-field='Document.dir'></span></td>
		<td class="actions">
					<div class="btn-group">
...
<?php echo $this->Form->create('Document',array('name'=>'modalForm','action'=>'add','class'=>'form-horizontal', 'model'=> 'documents', 'canvas'=>'#DocumentCanvasForm',
...
<div id="intent-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
  <div class="modal-header">
     <h3 id="intent-label"><span class="intent-text">Create </span><span class="intent-object">Document</span></h3>
  </div>
  <div class="modal-body">
  

<div class="row-fluid">
<div class="documents form span12">
		...
		<?php echo $this->Form->input('dir',array('placeholder'=>'Dir','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
</div>
</div>
...
<!-- CANVASFORM -->
<?php echo $this->Form->create('Document',array('action'=>'index',
															'class'=>'canvasForm',
															'id'=>'DocumentCanvasForm',
															'model'=> 'Document',
															'canvas'=>'#DocumentTable'
														)
											);?>
<?php echo $this->Form->end();?>
