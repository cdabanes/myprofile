...
<?php echo $this->Form->create('TeacherContact',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Teacher Contact'); ?></legend>
		<?php echo $this->Form->input('id',array('placeholder'=>'Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('teacher_id',array('placeholder'=>'Teacher Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
