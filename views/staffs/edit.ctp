...
<div class="row-fluid">
<div class="staffs form span6 offset3">
...
<?php echo $this->Form->create('Staff',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Staff'); ?></legend>
		...
		<?php echo $this->Form->input('position_id',array('placeholder'=>'Position Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
