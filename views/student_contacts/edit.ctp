...
<?php echo $this->Form->create('StudentContact',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Student Contact'); ?></legend>
		...
		<?php echo $this->Form->input('student_contactscol',array('placeholder'=>'Student Contactscol','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
	</fieldset>
