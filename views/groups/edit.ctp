...
<div class="row-fluid">
<div class="groups form span6 offset3">
...
<?php echo $this->Form->create('Group',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		...
		<?php echo $this->Form->input('User',array('placeholder'=>'User','between'=>'<div class="controls">','after'=>'</div>'));?>
	</fieldset>
