...
<div class="row-fluid">
<div class="relationships form span6 offset3">
...
<?php echo $this->Form->create('Relationship',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		...
		<?php echo $this->Form->input('primary',array('placeholder'=>'Primary','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('auxiliary',array('placeholder'=>'Auxiliary','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('relation_id',array('placeholder'=>'Relation Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
