				...
				<div class="row-fluid">
					<div class="span4 module">
						<div class="module-wrap">
							<div class="module-name events">
							
							 <?php echo $this->Html->link( 'Events',
														array('action' => 'index')
													);  ?>							</div>
						</div>
					</div>
...
<div class="row-fluid">
<div class="events form span6 offset3">
...
<?php echo $this->Form->create('Event',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		...
		<?php echo $this->Form->input('event_date',array('placeholder'=>'Event Date','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		...
		<?php echo $this->Form->input('is_repeating',array('placeholder'=>'Is Repeating','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
	</fieldset>
