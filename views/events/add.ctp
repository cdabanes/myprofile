...
<?php echo $this->Form->create('Event',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		...
		<?php echo $this->Form->input('event_date',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		...
		<?php echo $this->Form->input('is_repeating',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
	</fieldset>
