...
<?php echo $this->Form->create('DeveloperAffiliation',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Developer Affiliation'); ?></legend>
		<?php echo $this->Form->input('id',array('placeholder'=>'Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('developer_id',array('placeholder'=>'Developer Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
