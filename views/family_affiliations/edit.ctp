...
<?php echo $this->Form->create('FamilyAffiliation',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Family Affiliation'); ?></legend>
		<?php echo $this->Form->input('id',array('placeholder'=>'Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('family_id',array('placeholder'=>'Family Id','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		...
		<?php echo $this->Form->input('family_affiliationscol',array('placeholder'=>'Family Affiliationscol','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
	</fieldset>
