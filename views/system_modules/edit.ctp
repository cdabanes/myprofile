...
<div class="row-fluid">
<div class="systemModules form span6 offset3">

<?php echo $this->Form->create('SystemModule',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit System Module'); ?></legend>
		...
		<?php echo $this->Form->input('link',array('placeholder'=>'Link','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
