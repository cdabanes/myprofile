...
<?php echo $this->Form->create('EmployeeContact',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Employee Contact'); ?></legend>
		...
		<?php echo $this->Form->input('employee_contactscol',array('placeholder'=>'Employee Contactscol','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
	</fieldset>
