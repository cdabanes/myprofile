				...
				<div class="row-fluid">
					<div class="span4 module">
						<div class="module-wrap">
							<div class="module-name employeeAffiliations">
									 <?php echo $this->Html->link( 'Employee Affiliations',
															'javascript:void()'
														);  ?>								
							</div>
						</div>
...
<div class="sub-content-container">
	<div class="w90 center">
		<div class="row-fluid">
			<div class="w90 center">
						<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable" id="EmployeeAffiliationTable" model="EmployeeAffiliation">
			<thead>
				<tr>
																								<th class="w10 text-center"><a >Employee Id</a></th>
																				<th class="w10 text-center"><a >Key</a></th>
...
<?php echo $this->Form->create('EmployeeAffiliation',array('name'=>'modalForm','action'=>'add','class'=>'form-horizontal', 'model'=> 'employeeAffiliations', 'canvas'=>'#EmployeeAffiliationCanvasForm',
...
<div id="intent-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
  <div class="modal-header">
     <h3 id="intent-label"><span class="intent-text">Create </span><span class="intent-object">Employee Affiliation</span></h3>
  </div>
