...
<h2><?php  __('Place');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $place['Place']['longitude']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Latitude'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $place['Place']['latitude']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Type'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $place['Place']['type']; ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($place['School'] as $school):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $school['alias'];?></td>
			<td><?php echo $school['place_id'];?></td>
